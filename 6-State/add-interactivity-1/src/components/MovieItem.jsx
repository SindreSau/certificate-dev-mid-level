...
export default function MovieItem({ movie, onEdit, onDelete, onRatingChange }) {
    return (
            ...
            <div className='movie-item-content-wrapper'>
                ...
                <div className='movie-item-rating-wrapper'>
                    ...
                    <div className='movie-item-actions-list-wrapper'>
                        <button className='movie-item-action-edit-button' onClick={() => onEdit(movie.id)}>
...
function StarRating({ id, rating, movieName, onRatingChange }) {
    return (
